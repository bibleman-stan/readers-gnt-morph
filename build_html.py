...
def main():
    data_file = sys.argv[1] if len(sys.argv) > 1 else 'acts9_data.json'
    template = sys.argv[2] if len(sys.argv) > 2 else 'template.html'
    output = sys.argv[3] if len(sys.argv) > 3 else 'acts9_reader.html'
