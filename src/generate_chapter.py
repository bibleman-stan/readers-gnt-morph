...
# The real decomposition engine lives in src/morpheus.py (decompose_verb,
# decompose_nominal, clean_surface). decompose_word() below dispatches to it.
...
def normalize_for_match(w):
    ...
    # Remove common punctuation and editorial marks. Em-dash (— U+2014) and
    # en-dash (– U+2013) appear on sense-line tokens (e.g. 'ἀέρα—') but not on
    # MorphGNT words, so they must be stripped here at the comparison boundary
    # or the words fail to match.
